  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-2 md:p-4">
      ...
      <div className="relative w-full max-w-[98vw] max-h-[94vh] bg-white dark:bg-neutral-900 rounded-2xl shadow-2xl overflow-hidden flex flex-col">
        ...
        {/* Modal Header - Uses Dynamic Accent Background */}
            ...
            <div className="space-y-4">
              {itemsWithPrices.map((item) => (
                <div key={item.itemId} className="bg-white dark:bg-neutral-900 rounded-xl overflow-hidden shadow-lg border border-neutral-200 dark:border-neutral-800">
                  {/* Item Header - Uses Dynamic Accent */}
                  <div className="bg-[var(--accent-current)] px-4 py-3 transition-colors duration-300">
                    ...
                    <p className="text-white/80 text-sm">{item.className || item.description}</p>
                  </div>
                    ...
                    <table className="w-full text-sm md:text-base border-collapse">
                      ...
                      <tbody>
                        {item.ranges.map((range, rIdx) => {
                          ...
                          return (
                            <tr key={range.id} className={cn("hover:bg-[var(--accent-muted-current)] transition-colors", isFirstRow ? "bg-white dark:bg-neutral-900" : "bg-neutral-50 dark:bg-neutral-800/50")}>
                              {/* Standard Info */}
                              ...
                              {/* Price - Uses Dynamic Accent Text */}
                              <td className="p-2 md:p-3 text-right border border-neutral-200 dark:border-neutral-700">
                                <span className={cn("font-mono font-black", isFirstRow ? "text-lg text-[var(--accent-current)]" : "text-neutral-700 dark:text-neutral-300")}>
      ...
      <main className="w-full max-w-3xl px-4 md:px-6">
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-xl p-6 md:p-8">
          ...
          <div className="relative mb-8 z-20">
            ...
            {/* Search Dropdown - Uses Dynamic Accent */}
          ...
          <div className="space-y-6">
            ...
            {/* Generate Button - Uses Dynamic Accent */}
            <div className="pt-2">
              <button
        ...
        {/* Selected Item Preview - Uses Dynamic Accent Muted */}
        {selectedItem && (
