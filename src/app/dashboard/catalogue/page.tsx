              ...
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full h-16 px-4 text-lg font-bold bg-neutral-50 dark:bg-neutral-800 border-2 border-neutral-200 dark:border-neutral-700 rounded-xl focus:border-red-600 focus:ring-0 focus:outline-none transition-colors"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    className={cn(
                      "w-full h-16 px-4 text-lg font-bold bg-neutral-50 dark:bg-neutral-800 border-2 border-neutral-200 dark:border-neutral-700 rounded-xl focus:border-red-600 focus:ring-0 focus:outline-none transition-all",
