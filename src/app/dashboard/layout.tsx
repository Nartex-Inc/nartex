...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-[100svh] w-full">
      {/* Subtle background grid like modern SaaS */}
      <div className="pointer-events-none absolute inset-0 -z-10 [background:radial-gradient(1200px_600px_at_50%_-10%,hsl(var(--primary)/0.12),transparent_60%),conic-gradient(from_180deg_at_50%_0%,hsl(var(--border))_0deg,transparent_40deg)]" />

      <div className="mx-auto max-w-[1400px] px-5 pb-10 pt-8 sm:px-8">
        {/* Header / Filters */}
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-3">
          ...
          <ChartCard title="Répartition par produit (période)">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie data={byProduct} dataKey="revenue" nameKey="name" innerRadius={64} outerRadius={96}
                     strokeWidth={1.5}
                     fillOpacity={0.95}
                     >
                </Pie>
        ...
        <Card className="mt-6 rounded-2xl border-none bg-card/60 shadow-sm ring-1 ring-border/60 backdrop-blur">
          ...
          <CardContent>
            <Tabs defaultValue="customers" className="w-full">
              <TabsList className="mb-3 rounded-full bg-muted/60 p-1">
