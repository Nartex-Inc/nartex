...
import {
  NewProductRequestsTable
} from "@/components/dashboard/new-product-requests-table";
import {
  WelcomeBanner
...
import {
  ...
  mockRecentActivity,
} from "@/lib/data"; // Assuming you have this mock data
import {
...
export default function DashboardPage() {
  ...
  return (
    ...
    <
    StatCard title = "Projets Complétés"
    value = "12"
    label = "ce trimestre"
    description = {
      ...
      /> <
      StatCard title = "Efficacité du Pipeline"
      value = "92%"
      ...
      /> <
      StatCard title = "Temps de Cycle Moyen"
      value = "28 jours"
      label = "par projet"
      description = {
        ...
        section >
        <
        NewProductRequestsTable requests = {
          mockNewProductRequestsData
        }
        /> <
        /section> <
