...
function LoginForm() {
  ...
  return (
    <div className="h-full flex flex-col text-gray-100 font-sans antialiased relative">
      ...
      {/*
        FIX #1: REMOVED `items-center`.
        This stops the vertical centering conflict that caused the outer scrollbar.
        The content will now reliably start at the top of the main container.
      */}
      <main className="flex-1 flex justify-center px-6 relative z-10 overflow-y-auto">
        {/*
          FIX #2: This wrapper now also has `items-center` to center the content horizontally
          and vertically within the scrollable area. The vertical padding `py-12` ensures
          there is always space on the top and bottom when scrolling.
        */}
        <div className="flex w-full max-w-7xl items-center gap-16 2xl:gap-24 py-12">
          
          {/*
            FIX #3: Changed all `xl:` prefixes to `2xl:`.
            This gives your design the horizontal space it needs and prevents the
            "zoomed-in" look on standard laptop screens.
          */}
          <div className="hidden 2xl:flex 2xl:flex-col 2xl:w-1/2">
            
            <h1 className="text-5xl 2xl:text-6xl font-light tracking-tighter mb-6 flex flex-col">
          ...
          <div className="w-full 2xl:w-1/2">
            <div className="relative">
              ...
              <div className="relative bg-zinc-950/60 backdrop-blur-2xl border border-zinc-800/40 rounded-2xl p-8 md:p-12 shadow-2xl shadow-black/20">
