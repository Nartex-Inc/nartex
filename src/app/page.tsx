...
const GoogleIcon: React.FC<{ width?: number; height?: number; className?: string }> = ({
  width = 18,
  height = 18,
  className = "",
}) => (
...
const MicrosoftIcon: React.FC<{ width?: number; height?: number; className?: string }> = ({
  width = 18,
  height = 18,
  className = "",
}) => (
...
function LoginForm() {
  ...
  return (
    <div className="h-screen flex flex-col text-gray-100 font-sans antialiased relative">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-emerald-900/30 rounded-full blur-3xl opacity-20 -translate-x-1/2 -translate-y-1/2 pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-green-900/30 rounded-full blur-3xl opacity-20 translate-x-1/2 translate-y-1/2 pointer-events-none" />
        ...
        <div className="flex w-full max-w-6xl gap-24 items-center">
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative">
              <div className="absolute -inset-2 bg-gradient-to-r from-emerald-800/20 via-green-800/20 to-emerald-800/20 rounded-3xl blur-3xl opacity-40 animate-pulse-slow" />
              <div className="relative bg-zinc-950/60 backdrop-blur-2xl border border-zinc-800/40 rounded-2xl p-12 shadow-2xl shadow-black/20">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full group relative overflow-hidden py-3 px-4 bg-gradient-to-r from-emerald-600 to-green-600 rounded-lg text-white font-semibold text-sm transition-all shadow-lg hover:shadow-emerald-500/30 disabled:opacity-50"
                  >
                ...
                <div className="relative my-8">
                  ...
                  <div className="relative flex justify-center text-xs">
                    <span className="px-3 bg-zinc-950/60 text-zinc-500 uppercase tracking-wider">ou</span>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <button
                      key={provider}
                      onClick={() => handleSSOLogin(provider as "google" | "azure-ad")}
                    ...
                    >
                      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-emerald-500/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                      <span className="relative z-10 flex items-center justify-center">
