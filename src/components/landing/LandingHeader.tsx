    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        <a href="/landing" aria-label="Nartex accueil">
          <NartexLogo className="h-7 w-auto text-[hsl(var(--text-primary))]" />
        </a>

        <a
          href={CTA_HREF}
          className="rounded-lg bg-[hsl(var(--accent))] px-5 py-2.5 text-sm font-semibold text-[hsl(var(--bg-base))] transition-colors hover:bg-[hsl(var(--accent-hover))]"
        >
          Demander une démo
        </a>
      </div>
